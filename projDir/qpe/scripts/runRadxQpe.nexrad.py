...
def main():
    ...
    global options
    global scriptName
    scriptName = "runRadxQpe.nexrad.py"
    ...
    paramsDir = os.path.join(projDir, "qpe/params")
    paramsFile = os.path.join(paramsDir, "RadxQpe.nexrad")
    ...
    cmd = "RadxQpe -instance " + radar_name + " -params " + paramsFile + " -debug -f " + dataFilePath
